  ...
  return (
    <div className="w-full min-h-screen bg-[#F4F1EA] dark:bg-[#0B1E14] text-[#1F3E2F] dark:text-[#EAF4EE] font-sans selection:bg-[#1F3E2F] selection:text-white transition-colors duration-300 overflow-x-hidden">
      ...
      <section className="relative w-full pt-40 pb-20 px-4 sm:px-6 lg:px-8 max-w-[1400px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        >
          <div className="relative w-[90%] max-w-[540px] aspect-[4/3.5] rounded-[2rem] overflow-hidden shadow-2xl group">
            <img src="https://images.unsplash.com/photo-1544947950-fa07a98d237f?q=80&w=800&auto=format&fit=crop" alt="Featured Book" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
            {/* Gradient Overlay */}
            ...
            <div className="absolute inset-x-0 bottom-0 p-8 sm:p-10 flex flex-col items-start justify-end">
              ...
              <div className="flex items-end justify-between w-full gap-4">
                <div>
                  <h3 className="font-serif text-3xl sm:text-4xl text-white mb-2">The Kerala Story</h3>
                  <p className="text-white/70 text-sm sm:text-base font-medium">Srishtipadam Publications</p>
                </div>
      ...
      <section className="relative bg-[#173121] dark:bg-[#0A1910] text-white pt-32 pb-24 overflow-hidden mt-6">
        ...
        {/* Wave Divider - Top, Layer 2 (faster, drifts left-to-right, sits closer to content) */}
            ...
            >
              {isLoading ? (
                ...
                books.map((book, index) => (
                  ...
                  >
                    <img
                      src={book.coverImage || `https://images.unsplash.com/photo-1544947950-fa07a98d237f?q=80&w=400&auto=format&fit=crop&sig=${index}`}
                      alt={book.name}
                    ...
                    <div className="absolute inset-0 p-5 z-20 flex flex-col">
                      <div className="mt-auto">
                        <h3 className="text-white font-serif text-xl leading-tight mb-2">{book.name}</h3>
