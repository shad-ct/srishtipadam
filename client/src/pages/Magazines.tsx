...
const Magazines = () => {
  ...
  const price = priceData?.value || '399';
  ...
  const whatsappNumber = import.meta.env.VITE_WHATSAPP_NUMBER || '919061434300';
  const prefilledMessage = "Hello. I am willing to buy Srishtipadham's Annual Edition. Give me more details about it.";
  ...
  return (
    <div className="w-full bg-[#F4F1EA] dark:bg-[#070E0B] min-h-screen pt-32 pb-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            ...
            <span>Buy Our Annual Edition</span>
      ...
      {/* Annual Edition Modal / Bottom Sheet */}
      <AnimatePresence>
        {isAnnualModalOpen && (
          <motion.div
            initial={{ opacity: 0 }}
            ...
            >
              ...
              <div className="relative w-full md:w-[220px] lg:w-[250px] h-[140px] sm:h-[160px] md:h-auto bg-gradient-to-b from-[#112218] to-[#070E0B] flex items-center justify-center overflow-hidden flex-shrink-0">
                ...
                >
                  ...
                  <img src="/assets/images/annual_cover.png" alt="Annual Edition Cover" className="w-full h-full object-cover" />
                </motion.div>
              </div>
                ...
                <div className="flex-1 overflow-y-auto px-5 py-6 md:p-6 space-y-6">
                  ...
                  <div>
                    ...
                    <h2 className="text-2xl font-extrabold text-[#1F3E2F] dark:text-white mt-3" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", letterSpacing: '-0.02em' }}>
                      Srishtipadham Annual Edition
                    </h2>
                    <p className="text-[#5B7566] dark:text-[#9CB3A6] text-xs sm:text-sm leading-relaxed mt-2 font-medium">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                    ...
                    <div className="p-4 rounded-2xl bg-[#3DB86B]/03 dark:bg-white/03 border border-[#3DB86B]/10 backdrop-blur-sm flex flex-col items-start">
                      ...
                      <div className="text-[10px] text-[#5B7566] dark:text-[#9CB3A6]/60 font-semibold uppercase tracking-wider">Language</div>
                      <div className="text-sm font-bold text-[#1F3E2F] dark:text-white mt-0.5">Malayalam</div>
                    </div>
                    {/* Format */}
                    <div className="p-4 rounded-2xl bg-[#3DB86B]/03 dark:bg-white/03 border border-[#3DB86B]/10 backdrop-blur-sm flex flex-col items-start">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#3DB86B] mb-2 shrink-0">
                      ...
                      <div className="text-[10px] text-[#5B7566] dark:text-[#9CB3A6]/60 font-semibold uppercase tracking-wider">Format</div>
                      <div className="text-sm font-bold text-[#1F3E2F] dark:text-white mt-0.5">Printed Edition</div>
                    </div>
                    {/* Contents */}
                    <div className="p-4 rounded-2xl bg-[#3DB86B]/03 dark:bg-white/03 border border-[#3DB86B]/10 backdrop-blur-sm col-span-2 sm:col-span-1 flex flex-col items-start">
                      ...
                      <div className="text-[10px] text-[#5B7566] dark:text-[#9CB3A6]/60 font-semibold uppercase tracking-wider">Contents</div>
                      <div className="text-xs font-bold text-[#1F3E2F] dark:text-white mt-1 flex flex-wrap gap-1">
                        {['Poetry', 'Stories', 'Essays', 'Travel', 'Articles'].map(c => (
                    ...
                    <div className="p-4 rounded-2xl bg-[#3DB86B]/03 dark:bg-white/03 border border-[#3DB86B]/10 backdrop-blur-sm flex flex-col items-start">
                      ...
                      <div className="text-[10px] text-[#5B7566] dark:text-[#9CB3A6]/60 font-semibold uppercase tracking-wider">Delivery</div>
                      <div className="text-sm font-bold text-[#1F3E2F] dark:text-white mt-0.5">Across Kerala</div>
                    </div>
                    {/* Price */}
                    <div className="p-4 rounded-2xl bg-[#3DB86B]/10 border border-[#3DB86B]/25 backdrop-blur-sm col-span-2 sm:col-span-2 flex flex-col items-start">
                      ...
                      <div className="text-[10px] text-[#3DB86B] font-bold uppercase tracking-wider">Price</div>
                      <div className="text-xl sm:text-2xl font-extrabold text-[#1F3E2F] dark:text-white mt-0.5 flex items-baseline gap-1.5">
                        <span>₹{price}</span>
                        <span className="text-[11px] font-medium text-[#5B7566] dark:text-[#9CB3A6]/60">(Limited copies)</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="relative p-5 rounded-2xl bg-white/5 border border-[#3DB86B]/10 backdrop-blur-sm">
                    ...
                    <p className="text-[13px] sm:text-sm italic leading-relaxed text-[#1F3E2F]/90 dark:text-white/90" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                      "The Srishtipadham Annual Edition is a carefully curated literary collection celebrating creativity, language, and culture. Every copy showcases outstanding works from emerging and established writers, making it a timeless addition to every reader's collection."
                    </p>
                  </div>
